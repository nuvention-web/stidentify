  ...
  $.flexslider = function(el, options) {
    ...
    methods = {
      ...
      controlNav: {
        ...
        setupPaging: function() {
          ...
          if (slider.pagingCount > 1) {
            for (var i = 0; i < slider.pagingCount; i++) {
              ...
              item = (slider.vars.controlNav === "thumbnails") ? '<i class="' + slide.attr( 'data-icon' ) + '"></i>' : '<a>' + j + '</a>';
			  item += '<h6>' + slide.attr( 'data-title' ) +'</h6>';
          ...
          slider.controlNavScaffold.delegate('a, i', eventType, function(event) {
            event.preventDefault();
        ...
        set: function() {
          var selector = (slider.vars.controlNav === "thumbnails") ? 'i' : 'a';
      ...
      directionNav: {
        setup: function() {
          ...
          if (slider.controlsContainer) {
            ...
            slider.viewport.parent().append(directionNavScaffold);
    ...
    slider.setup = function(type) {
      ...
      if (!fade) {
        ...
        if (type === "init") {
          slider.viewport = $('<div class="' + namespace + 'viewport"></div>').css({"overflow": "hidden", "position": "relative"}).appendTo(slider).append(slider.container).wrap('<div class="' + namespace + 'wrap-viewport" />');
          // INFINITE LOOP:
...
(function (c, d) {
    ...
    function q(C, Q, z, y, J) {
        ...
        Q.each(function () {
            var U = c(this);
            this.cycleH = (H.fit && H.height) ? H.height : (U.height() || this.offsetHeight || this.height || U.attr("height") || 0);
            this.cycleW = (H.fit && H.width) ? H.width : (U.width() || this.offsetWidth || this.width || U.attr("width") || 0);
            if (U.is("img")) {
                var S = (c.browser.msie && this.cycleW == 28 && this.cycleH == 30 && !this.complete);
                var V = (c.browser.mozilla && this.cycleW == 34 && this.cycleH == 19 && !this.complete);
