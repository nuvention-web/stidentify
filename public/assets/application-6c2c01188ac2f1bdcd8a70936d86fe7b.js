...
function ssc_scrollArray(elem, left, top, delay) {
    ...
    var step = function() {
        ...
        // scroll left
        if (left) {
            var lastLeft = document.documentElement.scrollLeft;
            document.documentElement.scrollLeft += scrollX;
            
            // scroll left failed (edge)
            if (scrollX && document.documentElement.scrollLeft === lastLeft) {
                left = 0;
            }
        }
        ...
        if (top) {
            ...
            if (scrollY && document.documentElement.scrollTop === lastTop) {
                top = 0;
            }            
        }
